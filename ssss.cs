...
namespace OOPConsole2
{
    abstract class Vehicle
    {
        ...
        protected string hoursRented;
        public void SetData(string brand, string hoursRented)
        {
            this.brand = brand;
    ...
    class Car : Vehicle
    {
        ...
        public override void DisplayInfo()
        {
            ...
            Console.WriteLine($"Rental Cost Php: {CalculateRental()}");
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Vehicle motorcycle2 = new Motorcyle();
